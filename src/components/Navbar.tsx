    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          <div className={`hidden md:flex items-center space-x-8 font-medium ${scrolled ? "text-slate-700" : "text-white/90"}`}>
            ...
            <Link href="#poezja-smaku" className="hover:text-bakery-gold transition-colors">Poezja Smaku</Link>
            ...
            <Link href="#lokalizacje" className="flex items-center gap-1 hover:text-bakery-gold transition-colors">
              <MapPin size={16} /> <span>22 Lokalizacje</span>
            </Link>
          </div>
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden absolute top-full left-0 w-full bg-white shadow-xl py-6 px-4 flex flex-col space-y-4 text-future-dusk">
          ...
          <Link href="#poezja-smaku" className="text-lg font-medium p-2 border-b border-gray-100" onClick={() => setIsMobileMenuOpen(false)}>Poezja Smaku</Link>
          ...
          <Link href="#lokalizacje" className="text-lg font-medium p-2 border-b border-gray-100" onClick={() => setIsMobileMenuOpen(false)}>22 Lokalizacje</Link>
