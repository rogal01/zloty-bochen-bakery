        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 font-light">
              ...
              <li><Link href="#torty" className="hover:text-bakery-gold transition-colors">Torty Złotego Bochna</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-4 font-light">
              <li className="flex items-start gap-3">
                ...
                <span>ul. Miodowa 12<br />00-777 Nowe Brzegi</span>
              </li>
              <li className="flex items-center gap-3">
                <Phone size={18} className="text-bakery-gold shrink-0" />
                <span>+48 500 700 900</span>
              </li>
              <li className="flex items-center gap-3">
                <Mail size={18} className="text-bakery-gold shrink-0" />
                <span>kontakt@zlotybochen.example</span>
              </li>
            </ul>
          </div>
        </div>
