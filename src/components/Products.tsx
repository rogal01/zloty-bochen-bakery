...
export default function Products() {
  const cakeCategories = [
    { 
      title: "Klasyczne", 
      desc: "Lekkie bazy owocowe, biszkopt waniliowy. Malinowy, Cytrynowy.", 
      img: "https://images.unsplash.com/photo-1578985545062-69928b1d9587?q=80&w=1000&auto=format&fit=crop" 
    },
    { 
      title: "Premium", 
      desc: "Royal Choco, Royal Karmel, Pistacja. Bogate musy, orzechy, chrupki.", 
  ...
  return (
    <section className="py-24 bg-bakery-cream">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Poezja Smaku Section */}
        <div id="poezja-smaku" className="mb-24">
          <div className="text-center mb-16">
            <span className="text-bakery-gold uppercase tracking-widest text-sm font-semibold mb-4 block flex items-center justify-center gap-2">
              <Cake size={16} /> Marka Premium
            </span>
            <h2 className="text-4xl md:text-5xl font-serif text-future-dusk mb-6">Poezja Smaku</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {cakeCategories.map((cat, idx) => (
              <div key={idx} className="bg-white rounded-2xl overflow-hidden shadow-sm border border-slate-100 group hover-lift flex flex-col">
                ...
                <div className="p-8 flex-grow flex flex-col justify-between">
                  ...
                  <Link href="#konfigurator" className="text-bakery-gold font-medium flex items-center gap-2 group-hover:gap-3 transition-all">
        ...
        <div id="piekarnia" className="bg-white rounded-3xl p-8 md:p-16 shadow-xl relative overflow-hidden">
          <div className="absolute top-0 left-0 w-64 h-64 bg-bakery-gold/10 rounded-full blur-3xl -translate-y-1/2 -translate-x-1/2"></div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center relative z-10">
            <div>
              ...
              <p className="text-lg text-slate-600 mb-6 font-light leading-relaxed">
                W naszych zakładach produkcyjnych zapach świeżego chleba unosi się już od świtu. 
                Stosujemy tradycyjne metody fermentacji i receptury, które mają ponad pół wieku.
              </p>
              <ul className="space-y-4 mb-8">
                <li className="flex items-center gap-3 text-slate-700">
                  <div className="w-1.5 h-1.5 rounded-full bg-bakery-gold" /> 
                  <span>Tradycyjne receptury od 1969 r.</span>
                </li>
                <li className="flex items-center gap-3 text-slate-700">
                  <div className="w-1.5 h-1.5 rounded-full bg-bakery-gold" /> 
